...
public class FeaturePost {
    ...
    String senderId , senderName ,senderImage ,postImage ,companyName ,
    ...
    public String getTrainingInstitue() {
        return trainingInstitue;
    }

    public void setTrainingInstitue(String trainingInstitue) {
        this.trainingInstitue = trainingInstitue;
    }
